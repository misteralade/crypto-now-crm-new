...
const PageHeader = ({ title, subtitle, actions, className, onBack }: PageHeaderProps) => {
  ...
  return (
    <div className={`sticky top-0 z-20 bg-white rounded-br-[24px] rounded-bl-none shadow-sm mb-6 ${className ?? ''}`}>
      <div className="flex w-full flex-col gap-2 px-6 py-3 sm:py-4">
