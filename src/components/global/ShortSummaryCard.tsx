...
const ShortSummaryCard = ({ title, value, time, icon, trend }: ShortSummaryCardProps) => {
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 group">
      ...
      <p className="text-[24px] font-bold text-gray-900 leading-tight tracking-tight mb-1.5">
        {value}
      </p>
      <div className="flex items-center gap-2">
        {trend && (
          <span className={`text-[11px] font-medium px-2 py-0.5 rounded-full ${trend.up ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700'}`}>
