...
import type { AttachmentType, DisputeMessageResponse, MessageAttachment } from "../../../../types/response.payload.types";
import { useUploadQuery } from "../../../../queries/upload.query";
...
const DisputeMessage = ({ loading, messages, sendMessageMutation }: DisputeMessageProps) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      dispatch(setDisputeAttachments(uploadedAttachments));
